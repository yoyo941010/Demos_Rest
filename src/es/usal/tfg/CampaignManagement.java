...
/**
 * Clase principal del proyecto, encargada de gestionar las campañas, ademÃ¡s 
...
public class CampaignManagement implements ServletContextListener {
	 ...
	 * activos, un token estÃ¡ se introduce aqui al generarse en los metodos
	 * {@link CampaignManagement#register(String, String, String) registro} o
	 * {@link CampaignManagement#login(String, String) login} y tambiÃ©n cuando
	 ...
	 * tokens cada vez que llegan. Se borra una vez al dÃ­a.
	 * 
	 ...
	 * instancias, para mÃ¡s informaciÃ³n buscar patron Singleton
	 */
	...
	/**
	 * Comprueba si la estructura {@link CampaignManagement#campañas} estÃ¡ vacÃ­a.
	 *
	 * @return true, si estÃ¡ vacÃ­a, false, en caso contrario
	 */
	...
	/**
	 * Obtiene el FutureTask encargado de una creaciÃ³n de PDF y asociado al
	 ...
	 * mantenimiento y las programa para su ejecuciÃ³n a las 5 de la mañana
	 * 
	 ...
	 * o fracaso de la operaciÃ³n de registro
	 */
	@POST
	@Path("/register")
	...
	public Response register (@FormParam("campaign") String campaignName64, @FormParam("password") String password64, @FormParam("delete_date") String deleteDate64) {
		...
		// Posteriormente se crea el fichero en sÃ­ usando la clave configurada
		// en el keyStore
	...
	/**
	 * Borrar archivos de una campaña pasada por parÃ¡metro.
	 *
		...
		synchronized (lockCampaignsFile) {
			if (!campaignsFile.exists()) {
				...
				try {
					...
					System.err.println("["+new Date().toString()+"] inicializaCampañas: error abriendo el fichero o este estÃ¡ vacÃ­o");
					e.printStackTrace();
	 ...
	 * @param password64 contraseña de la campaña
	 * @return response con determinado codigo y mensaje en funcion del exito
	 * o fracaso de la operaciÃ³n de login
	 */
	@POST
	@Path("/login")
	@Consumes("application/x-www-form-urlencoded")
	 ...
	 * algunos mÃ©todos internos, no es invocado con peticiones HTTP.
	 *
	 * @param campaignName nombre de la campaña
	 * @param password contraseña de la campaña
	 * @return response un entero usado como cÃ³digo y que coincide con las 
	...
	/**
	 * Recibe peticiones de autenticaciÃ³n de token aceptando formularios de tipo 
	 * application/x-www-form-urlencoded.
	 * 
	 * @param token token que se desea autentica
	 * @param campaignName64 nombre de la campaña en base 64
	 * @return response con determinado codigo y mensaje en funcion del exito
	 * o fracaso de la operaciÃ³n de autenticaciÃ³n
	 */
	@POST
	 ...
	 * usado por algunos mÃ©todos internos, no es invocado con peticiones HTTP.
	 *
	...
	/**
	 * MÃ©todo invocado al parar el servidor Tomcat, se encarga de parar todos
	...
	/**
	 * MÃ©todo invocado al arrancar el servidor Tomcat, se implementa debido a 
	 * que es necesario el mÃ©todo 
	 ...
	 * de modo automÃ¡tico sin tener que recibir peticiÃ³n alguna para ello
	 * 
	 * @see javax.servlet.ServletContextListener#contextDestroyed(javax.servlet.ServletContextEvent)
	 */
	@Override
